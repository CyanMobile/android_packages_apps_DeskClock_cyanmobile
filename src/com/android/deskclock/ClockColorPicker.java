...
public class ClockColorPicker extends Activity implements SeekBar.OnSeekBarChangeListener 
{
	...
	private void loadPreferences()
	{
		aColor = new Integer(mPrefs.getInt(
				SettingsActivity.DIGITAL_CLOCK_ALPHA, DeskClock.DEFAULT_SCREENSAVER_COLOR_ALPHA));
        rColor = new Integer(mPrefs.getInt(
        		SettingsActivity.DIGITAL_CLOCK_RED, DeskClock.DEFAULT_SCREENSAVER_COLOR_RED));
        gColor = new Integer(mPrefs.getInt(
        		SettingsActivity.DIGITAL_CLOCK_GREEN, DeskClock.DEFAULT_SCREENSAVER_COLOR_GREEN));
        bColor = new Integer(mPrefs.getInt(
        		SettingsActivity.DIGITAL_CLOCK_BLUE, DeskClock.DEFAULT_SCREENSAVER_COLOR_BLUE));
	}
	
	private void saveColors()
	{
    	SharedPreferences.Editor editor = mPrefs.edit();
    	editor.putInt(SettingsActivity.DIGITAL_CLOCK_ALPHA, aColor);
    	editor.putInt(SettingsActivity.DIGITAL_CLOCK_RED, rColor);
    	editor.putInt(SettingsActivity.DIGITAL_CLOCK_GREEN, gColor);
    	editor.putInt(SettingsActivity.DIGITAL_CLOCK_BLUE, bColor);
    	editor.commit();
	}
